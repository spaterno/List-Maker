<?php
 ...
 if (isset($_POST['tags']))
  ...
  if(isset($_POST['bookbag']))
  {
     ...
     if (isset($_POST['bag_owner'])) $output_args .= "bucket_owner ".$_POST['bag_owner']." ";
  ...
  if (isset($_POST['copy_bucket']))
  {
     ...
     if (isset($_POST['copy_bucket_owner'])) $output_args .= "bucket_owner ".$_POST['copy_bucket_owner']." ";
     ...
     {
		  if (isset($_POST['copy_bucket_owner']))
		  {
