...
<form action="upload_confirm.php" method="post" enctype="multipart/form-data" id="stats">
   ...
   <p class="weeding">
     <input type="radio" name="data_type" id="bibs" class="report_type" value="bib" checked="checked"><label class="report_type">Bibs</label>
   ...
   <h3 class="weeding">File Type
    <span class="note"> <br />CSV file must have header row with "Document ID", "Record ID", "Barcode", or "ISBN" as column heading</span></h3>
   <p class="weeding">
