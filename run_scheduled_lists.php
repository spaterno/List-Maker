<?php 
  ...
  /************************* Daily ***********************************/
  $daily_sql = "SELECT email, filters, output, name 
  ...
  while($row = pg_fetch_row($result))
  {
      ...
      $args = $filter_args."email ".$email." scheduled report_name ".$name." ".$output_args;
  ...
  /************************* WEEKLY ***********************************/
  $weekly_sql = "SELECT email, filters, output, name 
                 FROM noble.scheduled_list
                 WHERE active = true
  ...
  $monthly_sql = "SELECT email, filters, output, name 
                  FROM noble.scheduled_list
                  WHERE active = true
  ...
  $relative_days_sql = "SELECT email, filters, output, relative_days_of_month, name
                        FROM noble.scheduled_list
                        WHERE active = true
                        AND schedule_type ='monthly'
