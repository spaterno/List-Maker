...
function setPreviousHTML()
{
   ...
   else if (layout.includes('Inline'))
   {
...
<h3 class="weeding"> Layout: </h3> 
   <p class="weeding">
      <input type="radio" name="layout" value="block" id="block_layout"  class="layout" onclick="ShowDisplayOptions()">
         <label id="block_label">Block&nbsp;</label>
            <a href="JavaScript:newPopup('https://syrup.noblenet.org/tools/common/block_list.png');" class="example"><img src='https://syrup.noblenet.org/shared/images/question-mark-small.png' class="help" /></a><br />
     
     <input type="radio" name="layout" value="inline" id="inline_layout" class="layout" onclick="ShowInlineDisplayOptions()">
     <label id="inline_label">Inline&nbsp;</label>
               <a href="JavaScript:newPopup('https://syrup.noblenet.org/tools/common/inline_list.png');" class="example"><img src='https://syrup.noblenet.org/shared/images/question-mark-small.png' class="help" /></a><br />
     
     <input type="radio" name="layout" value="grid" id="grid_layout" class="layout" onclick="SetGridWidth()" >
      <label id="cover_grid_label">Cover Grid</label>&nbsp;&nbsp;
           <span class="note">Grid Width </span>
           <input type="text" id="grid_width" size="2">
           
           <a href="JavaScript:newPopup('https://syrup.noblenet.org/tools/common/cover_grid.png');" class="example"><img src='https://syrup.noblenet.org/shared/images/question-mark-small.png' class="help" /></a> 
    </p>
<hr />    
     ...
     <table id="display_defaults">
      ...
      <tr>
        <td>
         ...
         <label id="call_number_label"> Call Number </label> <img src='https://syrup.noblenet.org/shared/images/question-mark-small.png' class="help" onclick="JavaScript:swal('Call Number','Call Number Prefix and Suffix will be included.', 'info');"/>
        </td>
      </tr>
...
<h3 class="weeding"> Options: </h3> 
  <p class="html_options">
      ...
      <label for="image_size"> Image Size </label><img src='https://syrup.noblenet.org/shared/images/question-mark-small.png' class="help" onclick="JavaScript:swal('Image Size','Size of Cover Image to display. Based on image version in Evergreen.','info');"/><br/>
      ...
      <label for="word_press"> Using WordPress </label><img src='https://syrup.noblenet.org/shared/images/question-mark-small.png' class="help" onclick="JavaScript:swal('Word Press','HTML generated will be in correct format to copy and paste directly into WordPress.','info');"/><br />
     
      <input type="checkbox" id="group_copies" name="group_copies" /> 
      <label for="group_copies"> Group Copies </label><img src='https://syrup.noblenet.org/shared/images/question-mark-small.png' class="help" onclick="JavaScript:swal('Group Copies','Will only write one set of information for multiple copies of the same title.','info');" />
      
      <div id="group_copy">
      <input type="radio" name="copies" value="first" id="first_copy" class="indent" checked>Show only First Copy <br/>
      <input type="radio" name="copies" value="all" id="all_copies" class="indent">Show All Copies<br/>
      </div>
