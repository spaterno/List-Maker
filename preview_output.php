        ...
        require_once('/var/www/shared/PHPMailer/class.phpmailer.php');   
		  ...
		  if (isset($_POST['use_active']))
		  {
           ...
           else if ($added_date_type == "relative") 
           {
              ...
              if ($added_time_type == "before") $filters->SetFilterByAddedRelative(null, $active_start);
              else if ($added_time_type == "after") $filters->SetFilterByAddedRelative($active_start, null);
              else if ($added_time_type == "between") 
              {
                 ...
                 if ($start_time == $end_time)
				     {
					     if ($start > $end)$filters->SetFilterByAddedRelative($active_start, $active_end);
					     else $filters->SetFilterByAddedRelative($active_end, $active_start);
					  }
					  else
					  {
					     if ($start_time == "days")
					     ...
					     {
					        if ($end_time == "days") $filters->SetFilterByAddedRelative($active_start, $active_end);
					        else if ($end_time == "months" || $end_time == "years" ) $filters->SetFilterByAddedRelative($active_end, $active_start);
					     }
					     else if ($start_time == "months")
					     {
					         if ($end_time == "days" || $end_time == "weeks") $filters->SetFilterByAddedRelative($active_start, $active_end);
					         else if ($end_time == "years" ) $filters->SetFilterByAddedRelative($active_end, $active_start);
					     }
		  ...
		  if (isset($_POST['status_change']))
		  {
		     ...
		     if($status_date_type == "absolute") 
           {
              ...
              if ($stat_time_type == "before") $filters->SetFilterByStatusChanged(null, $status_start);
              else if ($stat_time_type == "after") $filters->SetFilterByStatusChanged($status_start, null);
           ...
           else if($Sstatus_date_type == "relative") 
           {
              $start =$_POST['status_date_start_relative'];
              $start_time = $_POST['stat_start_time'];
              $status_start = $start."_".$start_time;
              
              if ($added_time_type == "before") $filters->SetFilterByStatusChangedRelative(null, $status_start);
              else if ($added_time_type == "after") $filters->SetFilterByStatusChangedRelative($status_start, null);
              else if ($added_time_type == "between") 
              {
                 ...
                 if ($start_time == $end_time)
				     {
					     if ($start > $end)$filters->SetFilterByStatusChangedRelative($status_start, $status_end);
					     else $filters->SetFilterByStatusChangedRelative($status_end, $status_start);
					  }
					  else
					  {
					     if ($start_time == "days")
					     ...
					     {
					        if ($end_time == "days") $filters->SetFilterByStatusChangedRelative($status_start, $status_end);
					        else if ($end_time == "months" || $end_time == "years" ) $filters->SetFilterByStatusChangedRelative($status_end, $status_start);
					     }
					     else if ($start_time == "months")
					     {
					         if ($end_time == "days" || $end_time == "weeks") $filters->SetFilterByStatusChangedRelative($status_start, $status_end);
					         else if ($end_time == "years" ) $filters->SetFilterByStatusChangedRelative($status_end, $status_start);
					     }
					     else if ($start_time == "years")
					     {
		  ...
		  $selected_stat_cat=$_POST['stat_cat'];
        $selected_stat_cat_entries=$_POST['stat_cat_entry'];
		  
		  if ($selected_stat_cat > 0)
		  {
		     if(strpos($selected_stat_cat_entries, "ALL") != false ) 
		     {
		         $entries = "all";
		     }
		     else 
		     {
		         $selected_stat_cat_entries =str_replace("(", "",$selected_stat_cat_entries);
		         $entries =str_replace(")", "",$selected_stat_cat_entries);
		     }
		     
		     $filters->SetFilterByStatCat($selected_stat_cat, $entries, true);		     
		  }
