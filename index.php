...
<title> List Maker  - Version 8.3 </title>
  ...
  <img src='../../shared/images/question-mark-small.png' class="help" onclick="JavaScript:swal('Invoice Date','Limit your search to items that have had their invoiced closed in this time period.', 'info');"/> </h3>
   ...
   <table class="output">
     ...
     <tr>
       ...
       <th>
        <input type="checkbox" id="bookbag" name="bookbag"  <?php if($use_bookbag)  echo "checked";?>/>
      ...
      <th>
        <input type="checkbox" id="copy_bucket" name="copy_bucket"  <?php if($use_copy_bucket)  echo "checked";?>/>
