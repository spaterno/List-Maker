...
class Output_Options
{
   ...
   function WriteOutputFiles($bib_list, $lib_name, $system_id, $show_deleted)
   {
      //figure out filename
      $today = date("U");
      $rand = rand(0, 2000);
   ...
   function SendCompletedEmail($count, $bib_count, $online_bib_count, $online_link_count, $type, $filter_text, $scheduled, $update_report_link, $domain)
   {
      ...
      $subject  .= $type;
       ...
       if($scheduled)
       {
          $message_body .= "This is a Scheduled Report.  If you want to view the report details, edit or turn off the scheduled report, use this link https://tools.noblenet.org/list_maker/edit_scheduled.php.\n";
   ...
   function SendTooBigToRunEmail($loc_count, $type, $filter_text, $scheduled, $update_report_link)
   {
       if ($this->collection) return;
