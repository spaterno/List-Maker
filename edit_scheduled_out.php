...
<div id="wrapper">
  ...
  <a href="edit_scheduled.php" class="top_link">Search again</a>
      ...
      <div class="list_info">
        ...
        <tbody>
          ...
          <tr>
             ...
             <td> <?php echo str_replace(",", "<br />", $email); ?></td>
          </tr>
...
?>
  ...
  <a href="edit_scheduled.php" class="top_link">Search again</a> <br /> <br />
